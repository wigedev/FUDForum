...
while ($r = db_rowarr($c)) {
    ...
    $avatars_data .= '<td class="' .
        alt_var('avatarsel_cl', 'Av1', 'Av2') .
        '">
<a href="javascript: window.opener.document.forms[\'fud_register\'].reg_avatar.value=\'' .
        $r[0] .
        '\'; window.opener.document.reg_avatar_img.src=\'/images/avatars/' .
        $r[2] .
        '\'; window.close();"><img src="/images/avatars/' .
        $r[2] .
        '" alt="" />
<br />
...
F()->response->avatars_data = $avatars_data;
