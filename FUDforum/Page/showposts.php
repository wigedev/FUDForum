...
F()->response->id = $_GET['id'];
F()->response->tabs = $tabs;
F()->response->uAlias = $u_alias;
F()->response->uRegDate = strftime('%a, %d %B %Y', $u_reg_date);
F()->response->pCount = $u_pcount;
F()->response->sortOrderR = $SORT_ORDER_R;
F()->response->postEntry = $post_entry;
...
<div class="content">
	...
	' . (__fud_real_user__ ? '<li><a href="/index.php?t=login&amp;' . _rsid . '&amp;logout=1&amp;SQ=' . $GLOBALS['sq'] . '" title="Logout"><img src="/theme/twig/images/top_logout.png" alt="" /> Logout [ ' . htmlspecialchars($usr->alias, null, null, false) . ' ]</a></li>' : '<li><a href="/index.php?t=login&amp;' . _rsid . '" title="Login"><img src="/theme/twig/images/top_login.png" alt="" /> Login</a></li>'); ?>
                ...
                <table cellspacing="1" cellpadding="2" class="ContentTable">
                    ...
                    <tr class="RowStyleA">
                        <td class="GenText wa">Login: <a
                                href="/index.php?t=usrinfo&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>"><?php echo htmlspecialchars($u_alias, null, null, false); ?></a>
                        </td>
                        <td class="GenText nw">Registered on <?php echo strftime('%a, %d %B %Y', $u_reg_date); ?></td>
                    ...
                    <tr>
                        ...
                        <th class="nw"><a class="thLnk"
                                href="/index.php?t=showposts&amp;so=<?php echo $SORT_ORDER_R; ?>&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>"
                                rel="nofollow">Date Posted</a></th>
                    </tr>
                    <?php echo $post_entry; ?>
                </table>
                <?php echo $pager; ?>
