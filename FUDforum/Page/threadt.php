...
function draw_forum_path($cid, $fn='', $fid=0, $tn='')
{
							...
							if ($TREE_THREADS_MAX_DEPTH > $lev) {
								...
								if (_uid) {
									if ($usr->last_read < $cur->post_stamp && $cur->post_stamp>$cur->last_view) {
										$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/twig/images/unreadlocked.png" title="Locked topic with unread messages" alt="" />'	: '<img src="/theme/twig/images/unread.png" title="This topic contains messages you have not yet read" alt="" />';
									} else {
										$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/twig/images/readlocked.png" title="This topic has been locked" alt="" />' : '<img src="/theme/twig/images/read.png" title="This topic has no unread messages" alt="" />';
									}
								} else {
									$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/twig/images/readlocked.png" title="This topic has been locked" alt="" />' : '<img src="/theme/twig/images/read.png" title="The read &amp; unread messages are only tracked for registered users" alt="" />';
								}
	...
	<td title="'.$cur->tdescr.'" class="tt" style="padding-left: '.(20 * ($lev - 1)).'px">
		'.($cur->poll_id ? 'Poll:&nbsp;' : '' ) .'
		'.($cur->attach_cnt ? '<img src="/theme/twig/images/attachment.gif" alt="" />' : '' ) .'
...
<b>::</b> <a href="/index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Message Navigator</a>
	...
	<td class="GenText nw vb ar"><a href="/index.php?t=thread&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img alt="Return to the default flat view" title="Return to the default flat view" src="/theme/twig/images/flat_view.gif" /></a>&nbsp;<a href="/index.php?t=post&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img src="/theme/twig/images/new_thread.gif" alt="Create a new topic" /></a></td>
</tr>
</table>
...
[ <a href="/feed.php?mode=m&amp;l=1&amp;basic=1&amp;frm='.$frm->id.'&amp;n=10"><img src="/theme/twig/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : '' ) .(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="/pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="/theme/twig/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : '' )  .'</div>' : '<div class="ar SmallText">'.(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="/pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="/theme/twig/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : '' ) .($FUD_OPT_2 & 1048576 ? '&nbsp;[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Syndicate this forum (XML)</a> ]
[ <a href="/feed.php?mode=m&amp;l=1&amp;basic=1&amp;frm='.$frm->id.'&amp;n=10"><img src="/theme/twig/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : '' )  .'</div>'); ?>
<fieldset>
	...
	<img src="/theme/twig/images/unreadlocked.png" alt="Locked (w/ unread messages)" />&nbsp;Locked (w/ unread messages)&nbsp;&nbsp;
	<img src="/theme/twig/images/readlocked.png" alt="Locked" />&nbsp;Locked&nbsp;&nbsp;
	<img src="/theme/twig/images/moved.png" alt="Moved to another forum" />&nbsp;Moved to another forum
</fieldset>
