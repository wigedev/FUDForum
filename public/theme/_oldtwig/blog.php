...
* $Id: blog.php.t 6278 2019-05-25 15:24:44Z naudefj $
*
...
<link rel="alternate" type="application/rss+xml" title="Syndicate this forum (XML)" href="/rdf.php?mode=m&amp;l=1&amp;basic=1&amp;n=10">
' : '' )  ;
...
<a href="/index.php?t='.d_thread_view.'&amp;th='.$topic->id.'&amp;unread=1&amp;'._rsid.'">'.convertPlural($topic->replies, array(''.$topic->replies.' comment',''.$topic->replies.' comments')).'</a>
' : '
<a href="/index.php?t=msg&amp;th='.$topic->thread_id.'&amp;'._rsid.'">'.convertPlural($topic->replies, array(''.$topic->replies.' comment',''.$topic->replies.' comments')).'</a>
' ) .'</span>
    </div>
<!--
				'.($topic->icon ? '
...
<div class="blog_div"><div class="MsgBodyText">
				...
				<span style="color: #666666;font-size: 8pt;">Written by TEMPLATE: blog_msg_user_login</span><span class="DateText"> '.strftime('%a, %d %B %Y %H:%M', $topic->post_stamp).'</span> - <a href="/index.php/t/'.$topic->thread_id.'/'._rsid.'#quickreply" class="button">'.$thread_read_status.' There are (<span style="color:black">'.$topic->replies.'</span>) comments on the article.</a><br><br><br>
-->';
	}
...
' : '' ) .'
    <br />
<div style="float: right"><a href="/rdf.php?mode=m&amp;l=1&amp;basic=1&amp;n=10" class="button"><img src="/theme/twig/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" width="16" height="16"> RSS</a></div>
  </div>
</div>
<!-- /table -->';
