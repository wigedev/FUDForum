...
F()->response->srch = $srch;
F()->response->searchOptions = $search_options;
F()->response->forumLimitData = $forum_limit_data;
F()->response->attachOptions = $attach_options;
F()->response->logicOptions = $logic_options;
F()->response->sortOptions = $sort_options;
F()->response->author = $author;
F()->response->searchData = $search_data;
F()->response->pagePager = $page_pager;
