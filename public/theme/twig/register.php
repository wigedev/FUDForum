...
<tr class="child-c2 RowStyleA" style="display: none;">
	<td colspan="2">
		...
		<tr>
			<td>
				<label>Yahoo Messenger:<br /><img src="/theme/twig/images/yahoo.png" alt="" />
				<input type="text" name="reg_yahoo" value="<?php echo $reg_yahoo; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>MSN Messenger:<br /><img src="/theme/twig/images/msnm.png" alt="" />
		...
		<tr>
			<td>
				<label>Jabber Handle:<br /><img src="/theme/twig/images/jabber.png" alt="" />
				<input type="text" name="reg_jabber" value="<?php echo $reg_jabber; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Google Chat/IM Handle:<br /><img src="/theme/twig/images/google.png" alt="" />
		...
		<tr>
			<td>
				<label>Skype Handle:<br /><img src="/theme/twig/images/skype.png" alt="" />
				<input type="text" name="reg_skype" value="<?php echo $reg_skype; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Twitter Handle:<br /><img src="/theme/twig/images/twitter.png" alt="" />
