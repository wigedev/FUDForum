...
* $Id: reported.php.t 5963 2016-06-30 07:00:44Z naudefj $
*
...
if (_uid) {
	...
	<td class="RowStyleC">
		...
		<div class="MsgR2">
			...
			<br />
			[ <a href="/index.php?t=reported&amp;'._rsid.'&amp;del='.$obj->report_id.'&amp;SQ='.$GLOBALS['sq'].'">Delete Report</a> ]
		</div>
	</td>
</tr>
...
F()->response->reportedMessage = $reported_message;
