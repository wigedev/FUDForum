...
<span id="threadRating"><?php echo ($FUD_OPT_2 & 4096 && $frm->rating ? '&nbsp;('.($MOD ? '<a href="javascript://" onclick="window_open(\'/index.php?t=ratingtrack&amp;'._rsid.'&amp;th='.$frm->id.'\', \'th_rating_track\', 300, 400);">' : '' )  .'<img src="/theme/twig/images/'.$frm->rating.'stars.gif" title="'.$frm->rating.' from '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' vote',''.$frm->n_rating.' votes')).'" alt=""/>'.($MOD ? '</a>' : '' )  .') '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' Vote',''.$frm->n_rating.' Votes')).'' : ''); ?></span>
...
<td class="vb ar">
	<?php echo ($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Switch to threaded view of this topic" alt="Switch to threaded view of this topic" src="/theme/twig/images/tree_view.gif" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/twig/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/twig/images/post_reply.gif" alt="Submit Reply" /></a>' : ''); ?>
</td>
</tr>
</table>
...
<tr>
	...
	<td class="GenText ar vb nw">'.($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Switch to threaded view of this topic" alt="Switch to threaded view of this topic" src="/theme/twig/images/tree_view.gif" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/twig/images/new_thread.gif" /></a><?php echo (!$quick_reply_enabled && (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/twig/images/post_reply.gif" alt="Submit Reply" /></a>' : ''); ?></td>
</tr>
</table>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Syndicate this forum (XML)</a> ] [ <a href="/feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="/theme/twig/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="/pdf.php?th='.$th.'&amp;'._rsid.'"><img src="/theme/twig/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : ''); ?></div>
<br /><div class="ac"><span class="curtime"><b>Current Time:</b> <?php echo strftime('%a %b %d %H:%M:%S %Z %Y', __request_timestamp__); ?></span></div>
<?php echo $page_stats; ?>
<script>
	min_max_posts('/theme/twig/images', 'Minimize Message', 'Maximize Message');
