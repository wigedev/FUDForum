...
* $Id: tree.php.t 6078 2017-09-25 14:57:31Z naudefj $
*
...
' : '' )  ;
	...
	if (_uid) {
		...
		$bookmark_status  = $frm->bookmarked ? '| <a href="/index.php?t=tree&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;mid='.$mid.'&amp;SQ='.$GLOBALS['sq'].'" title="Remove this topic from your list of bookmarks">Remove from bookmarks</a>&nbsp;' : '| <a href="/index.php?t=tree&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;mid='.$mid.'&amp;SQ='.$GLOBALS['sq'].'" title="Add this topic to your list of bookmarks">Bookmark topic</a>&nbsp;';
	} else {
...
function draw_forum_path($cid, $fn='', $fid=0, $tn='')
{
	...
	<td>'.((_uid && $cur->post_stamp > $usr->last_read && $cur->post_stamp > $frm->last_view) ? '<img id="msgIm'.$cur->id.'" src="/theme/twig/images/unread.png" alt="Unread Message" title="Unread Message" />' : '<img src="/theme/twig/images/read.png" alt="Read Message" title="Read Message" />' ) .'</td>
...
<b>::</b> <a href="/index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Message Navigator</a>
		...
		<?php echo ($perms & 8192 ? ($frm->replies ? '<a href="/index.php?t=movemsg&amp;th='.$th.'">Move messages</a>&nbsp;|&nbsp;' : '' )  .'<a href="javascript://" onclick="window_open(\'/index.php?t=mvthread&amp;'._rsid.'&amp;th='.$th.'\', \'th_move\', 300, 400);">Move</a>&nbsp;|&nbsp;' : '' ) .$lock_thread.'
	...
	<td class="vb ar">
		<a href="/index.php?t=msg&amp;th=<?php echo $th; ?>&amp;<?php echo _rsid; ?>#msg_<?php echo $mid; ?>"><img alt="Return to the default flat view" title="Return to the default flat view" src="/theme/twig/images/flat_view.gif" /></a>&nbsp;<a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/twig/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$mid.'&amp;'._rsid.'"><img alt="Submit Reply" src="/theme/twig/images/post_reply.gif" /></a>' : ''); ?>
	</td>
</tr>
</table>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Syndicate this forum (XML)</a> ] [ <a href="/feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="/theme/twig/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="/pdf.php?msg='.$mid.'&amp;'._rsid.'"><img src="/theme/twig/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : ''); ?></div>
