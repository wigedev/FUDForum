...
<span id="threadRating"><?php echo ($FUD_OPT_2 & 4096 && $frm->rating ? '&nbsp;('.($MOD ? '<a href="javascript://" onclick="window_open(\'/index.php?t=ratingtrack&amp;'._rsid.'&amp;th='.$frm->id.'\', \'th_rating_track\', 300, 400);">' : '' )  .'<img src="/theme/responsive/images/'.$frm->rating.'stars.gif" title="'.$frm->rating.' from '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' vote',''.$frm->n_rating.' votes')).'" alt=""/>'.($MOD ? '</a>' : '' )  .') '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' Vote',''.$frm->n_rating.' Votes')).'' : ''); ?></span>
...
<td class="vb ar">
	<?php echo ($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Switch to threaded view of this topic" alt="Switch to threaded view of this topic" src="/theme/responsive/images/tree_view.gif" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/responsive/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/responsive/images/post_reply.gif" alt="Submit Reply" /></a>' : ''); ?>
</td>
</tr>
</table>
...
<span class="FormattingToolsBG">
	<span class="FormattingToolsCLR"><a title="Bold" accesskey="b" href="javascript: insertTag(\'txtb\', \'[b]\', \'[/b]\');"><img alt="" src="/theme/responsive/images/b_bold.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Italics" accesskey="i" href="javascript: insertTag(\'txtb\', \'[i]\', \'[/i]\');"><img alt="" src="/theme/responsive/images/b_italic.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Underline" accesskey="u" href="javascript: insertTag(\'txtb\', \'[u]\', \'[/u]\');"><img alt="" src="/theme/responsive/images/b_underline.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Align Left" href="javascript: insertTag(\'txtb\', \'[ALIGN=left]\', \'[/ALIGN]\');"><img alt="" src="/theme/responsive/images/b_aleft.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Align Center" href="javascript: insertTag(\'txtb\', \'[ALIGN=center]\', \'[/ALIGN]\');"><img alt="" src="/theme/responsive/images/b_acenter.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Align Right" href="javascript: insertTag(\'txtb\', \'[ALIGN=right]\', \'[/ALIGN]\');"><img alt="" src="/theme/responsive/images/b_aright.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Insert a Link" accesskey="w" href="javascript: url_insert(\'Link location:\');"><img alt="" src="/theme/responsive/images/b_url.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Insert an E-mail address" accesskey="e" href="javascript: email_insert(\'E-mail address:\');"><img alt="" src="/theme/responsive/images/b_email.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Insert an image" accesskey="m" href="javascript: image_insert(\'Image URL:\');"><img alt="" src="/theme/responsive/images/b_image.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Add numbered list" accesskey="l" href="javascript: window_open(\'/index.php?t=mklist&amp;'._rsid.'&amp;tp=OL:1\', \'listmaker\', 350, 350);"><img alt="" src="/theme/responsive/images/b_numlist.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Add bulleted list" href="javascript: window_open(\'/index.php?t=mklist&amp;'._rsid.'&amp;tp=UL:square\', \'listmaker\', 350, 350);"><img alt="" src="/theme/responsive/images/b_bulletlist.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Add Quote" accesskey="q" href="javascript: insertTag(\'txtb\', \'[quote]\', \'[/quote]\');"><img alt="" src="/theme/responsive/images/b_quote.gif" /></a></span>
	<span class="FormattingToolsCLR"><a title="Add Code" accesskey="c" href="javascript: insertTag(\'txtb\', \'[code]\', \'[/code]\');"><img alt="" src="/theme/responsive/images/b_code.gif" /></a></span>
</span>
<span class="hide1">
&nbsp;&nbsp;
...
<tr>
	...
	<td class="GenText ar vb nw">'.($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Switch to threaded view of this topic" alt="Switch to threaded view of this topic" src="/theme/responsive/images/tree_view.gif" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/responsive/images/new_thread.gif" /></a><?php echo (!$quick_reply_enabled && (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/responsive/images/post_reply.gif" alt="Submit Reply" /></a>' : ''); ?></td>
</tr>
</table>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Syndicate this forum (XML)</a> ] [ <a href="/feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="/theme/responsive/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="/pdf.php?th='.$th.'&amp;'._rsid.'"><img src="/theme/responsive/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : ''); ?></div>
