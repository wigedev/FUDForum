...
<tr>
	...
	<td class="nw GenText"><a href="/index.php?t=showposts&amp;id='.$r[1].'&amp;'._rsid.'"><img src="/theme/responsive/images/show_posts.gif" alt="Show Posts" /></a>'.((_uid && $FUD_OPT_1 & 1024) ? '&nbsp;<a href="/index.php?t=ppost&amp;'._rsid.'&amp;toi='.$r[1].'"><img src="/theme/responsive/images/msg_pm.gif" alt="PM" /></a>' : '' ) .(!empty($r[4]) ? '&nbsp;<a href="'.$r[4].'"><img src="/theme/responsive/images/homepage.gif" alt="Home"/></a>' : '' ) .($FUD_OPT_2 & 1073741824 ? '&nbsp;<a href="/index.php?t=email&amp;toi='.$r[1].'&amp;'._rsid.'" rel="nofollow"><img src="/theme/responsive/images/msg_email.gif" alt="E-mail" /></a>' : '' ) .'</td>
</tr>';
			} while (($r = db_rowarr($c)));
		} else {
