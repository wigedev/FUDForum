...
<div class="GenText ac">
	[ <a href="/index.php?t=online_today&rand=<?php echo get_random_value(); ?>&<?php echo _rsid; ?>" rel="nofollow">Refresh List</a> ]
	[ <a href="/index.php?t=actions&amp;<?php echo _rsid; ?>" rel="nofollow">User Activity</a> ]
</div>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th><a href="/index.php?t=online_today&amp;o=alias&amp;s=<?php echo ($o=='u.alias' && $s=='ASC' ? 'd' : 'a'); ?>&amp;<?php echo _rsid; ?>" class="thLnk" rel="nofollow">User</a></th>
	<th><a href="/index.php?t=online_today&amp;<?php echo _rsid; ?>&amp;o=last_visit&amp;s=<?php echo ($o=='u.last_visit' && $s=='ASC' ? 'd' : 'a'); ?>&amp;<?php echo _rsid; ?>" class="thLnk" rel="nofollow">Last Visited</a></th>
	<th>Last Message</th>
</tr>
