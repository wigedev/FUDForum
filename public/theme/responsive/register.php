...
<tr class="child-c2 RowStyleA" style="display: none;">
	<td colspan="2">
		...
		<tr>
			<td>
				<label>ICQ:<br /><img src="/theme/responsive/images/icq.png" alt="" />
				<input type="text" name="reg_icq" value="<?php echo $reg_icq; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>AIM Handle:<br /><img src="/theme/responsive/images/aim.png" alt="" />
		...
		<tr>
			<td>
				<label>Yahoo Messenger:<br /><img src="/theme/responsive/images/yahoo.png" alt="" />
				<input type="text" name="reg_yahoo" value="<?php echo $reg_yahoo; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>MSN Messenger:<br /><img src="/theme/responsive/images/msnm.png" alt="" />
		...
		<tr>
			<td>
				<label>Jabber Handle:<br /><img src="/theme/responsive/images/jabber.png" alt="" />
				<input type="text" name="reg_jabber" value="<?php echo $reg_jabber; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Google Chat/IM Handle:<br /><img src="/theme/responsive/images/google.png" alt="" />
		...
		<tr>
			<td>
				<label>Skype Handle:<br /><img src="/theme/responsive/images/skype.png" alt="" />
				<input type="text" name="reg_skype" value="<?php echo $reg_skype; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Twitter Handle:<br /><img src="/theme/responsive/images/twitter.png" alt="" />
...
<script>
        min_max_cats("/theme/responsive/images", "Minimize Category", "Maximize Category", "", "");
	...
	$(document).ready(function() {
            ...
            $("#reg_login").change(function() {
                 $("#reg_login-result").html("<img src='/theme/responsive/images/ajax-loader.gif' />");
 
                 $.ajax({
                    url:"index.php?t=autocomplete&check=login&term=" + $("#reg_login").val(),
                    success:function(data) {
                        if (data==1) {
                            $("#reg_login-result").html("<img src='/theme/responsive/images/tick.png' />Available");
                        } else {
                            $("#reg_login-result").html("<img src='/theme/responsive/images/cross.png' /> Already taken");
                        }
                    }
                 });
            });
