...
}function tmpl_drawpmsg($obj, $usr, $mini)
{
	...
	if (!$mini) {
		...
		if (($o2 & 32 && !($a & 32768)) || $b & 1048576) {
			$obj->login = $obj->alias;
			$online_indicator = (($obj->last_visit + $GLOBALS['LOGEDIN_TIMEOUT'] * 60) > __request_timestamp__) ? '<img src="/theme/responsive/images/online.png" alt="'.$obj->login.' is currently online" title="'.$obj->login.' is currently online" />' : '<img src="/theme/responsive/images/offline.png" alt="'.$obj->login.' is currently offline" title="'.$obj->login.' is currently offline" />';
		} else {
			$online_indicator = '';
		}
		...
		if ($b & 16384) {
			$im = '';
			if ($obj->icq) {
				$im .= '<a href="/index.php?t=usrinfo&amp;id='.$obj->user_id.'&amp;'._rsid.'#icq_msg"><img src="/theme/responsive/images/icq.png" alt="" title="'.$obj->icq.'" /></a>&nbsp;';
			}
			if ($obj->aim) {
				$im .= '<a href="aim:goim?screenname='.$obj->aim.'&amp;message=Hi.+Are+you+there?"><img src="/theme/responsive/images/aim.png" title="'.$obj->aim.'" alt="" /></a>&nbsp;';
			}
			if ($obj->yahoo) {
				$im .= '<a href="http://edit.yahoo.com/config/send_webmesg?.target='.$obj->yahoo.'&amp;.src=pg"><img src="/theme/responsive/images/yahoo.png" alt="" title="'.$obj->yahoo.'" /></a>&nbsp;';
			}
			if ($obj->msnm) {
				$im .= '<a href="mailto:'.$obj->msnm.'"><img src="/theme/responsive/images/msnm.png" title="'.$obj->msnm.'" alt="" /></a>';
			}
			if ($obj->jabber) {
		...
		if ($obj->ouser_id != _uid) {
			$user_profile = '<a href="/index.php?t=usrinfo&amp;id='.$obj->user_id.'&amp;'._rsid.'"><img src="/theme/responsive/images/msg_about.gif" alt="" /></a>';
			$email_link = ($o1 & 4194304 && $a & 16) ? '<a href="/index.php?t=email&amp;toi='.$obj->user_id.'&amp;'._rsid.'" rel="nofollow"><img src="/theme/responsive/images/msg_email.gif" alt="" /></a>' : '';
			$private_msg_link = '<a href="/index.php?t=ppost&amp;toi='.$obj->user_id.'&amp;'._rsid.'"><img title="Send a private message to this user" src="/theme/responsive/images/msg_pm.gif" alt="" /></a>';
		} else {
...
<td class="nw ar"><a href="/index.php?t=pmsg&amp;'._rsid.'&amp;btn_delete=1&amp;sel='.$obj->id.'&amp;SQ='.$GLOBALS['sq'].'"><img src="/theme/responsive/images/msg_delete.gif" alt="" /></a>&nbsp;'.($obj->fldr == 4 ? '<a href="/index.php?t=ppost&amp;msg_id='.$obj->id.'&amp;'._rsid.'"><img src="/theme/responsive/images/msg_edit.gif" alt="" /></a>&nbsp;&nbsp;&nbsp;&nbsp;' : '' )  .($obj->fldr == 1 ? '<a href="/index.php?t=ppost&amp;reply='.$obj->id.'&amp;'._rsid.'"><img src="/theme/responsive/images/msg_reply.gif" alt="" /></a>&nbsp;<a href="/index.php?t=ppost&amp;quote='.$obj->id.'&amp;'._rsid.'"><img src="/theme/responsive/images/msg_quote.gif" alt="" /></a>&nbsp;' : '' )  .'<a href="/index.php?t=ppost&amp;forward='.$obj->id.'&amp;'._rsid.'"><img src="/theme/responsive/images/msg_forward.gif" alt="" /></a></td>
</tr></table></td></tr>';
	} else {
...
<tr>
	...
	if (($nid = q_singleval(q_limit('SELECT p.id FROM fud30_pmsg p INNER JOIN fud30_users u ON u.id=p.ouser_id WHERE p.duser_id='. _uid .' AND p.fldr='. $m->fldr .' AND post_stamp>'. $m->post_stamp .' ORDER BY p.post_stamp ASC', 1)))) {
		$dpmsg_next_message = '<a href="/index.php?t=pmsg_view&amp;'._rsid.'&amp;id='.$nid.'">Next message <img src="/theme/responsive/images/goto.gif" alt="" /></a>';
	} else {
		$dpmsg_next_message = '';
	}
	...
	if (($pid = q_singleval(q_limit('SELECT p.id FROM fud30_pmsg p INNER JOIN fud30_users u ON u.id=p.ouser_id WHERE p.duser_id='. _uid .' AND p.fldr='. $m->fldr .' AND p.post_stamp<'. $m->post_stamp .' ORDER BY p.post_stamp DESC', 1)))) {
		$dpmsg_prev_message = '<a href="/index.php?t=pmsg_view&amp;'._rsid.'&amp;id='.$pid.'"><img src="/theme/responsive/images/goback.gif" alt="" /> Previous message</a>';
	} else {
		$dpmsg_prev_message = '';
	}
