...
<tr class="RowStyleA">
	<td class="GenText wa">Login: <a href="/index.php?t=usrinfo&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>"><?php echo htmlspecialchars($u_alias, null, null, false); ?></a></td>
...
<tr>
	...
	<th class="nw"><a class="thLnk" href="/index.php?t=showposts&amp;so=<?php echo $SORT_ORDER_R; ?>&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>" rel="nofollow">Date Posted</a></th>
</tr>
<?php echo $post_entry; ?>
</table>
<?php echo $pager; ?>
