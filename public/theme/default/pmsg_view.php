...
}function tmpl_drawpmsg($obj, $usr, $mini)
{
	...
	if (!$mini) {
		...
		if ($b & 16384) {
			...
			if ($obj->aim) {
				$im .= '<a href="aim:goim?screenname='.$obj->aim.'&amp;message=Hi.+Are+you+there?"><img src="/theme/default/images/aim.png" title="'.$obj->aim.'" alt="" /></a>&nbsp;';
			}
			if ($obj->yahoo) {
			...
			if ($obj->msnm) {
				$im .= '<a href="mailto:'.$obj->msnm.'"><img src="/theme/default/images/msnm.png" title="'.$obj->msnm.'" alt="" /></a>';
			}
			if ($obj->jabber) {
