...
function draw_forum_path($cid, $fn='', $fid=0, $tn='')
{
	...
	<td>'.((_uid && $cur->post_stamp > $usr->last_read && $cur->post_stamp > $frm->last_view) ? '<img id="msgIm'.$cur->id.'" src="/theme/default/images/unread.png" alt="Unread Message" title="Unread Message" />' : '<img src="/theme/default/images/read.png" alt="Read Message" title="Read Message" />' ) .'</td>
...
<b>::</b> <a href="/index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Message Navigator</a>
	...
	<td class="vb ar">
		<a href="/index.php?t=msg&amp;th=<?php echo $th; ?>&amp;<?php echo _rsid; ?>#msg_<?php echo $mid; ?>"><img alt="Return to the default flat view" title="Return to the default flat view" src="/theme/default/images/flat_view.gif" /></a>&nbsp;<a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/theme/default/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$mid.'&amp;'._rsid.'"><img alt="Submit Reply" src="/theme/default/images/post_reply.gif" /></a>' : ''); ?>
	</td>
</tr>
</table>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Syndicate this forum (XML)</a> ] [ <a href="/feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="/theme/default/images/rss.gif" title="Syndicate this forum (XML)" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="/pdf.php?msg='.$mid.'&amp;'._rsid.'"><img src="/theme/default/images/pdf.gif" title="Generate printable PDF" alt="PDF" /></a> ]' : ''); ?></div>
