...
<tr class="RowStyleA GenText ac">
	<td>
		...
		[<a href="/index.php?t=pre_reg&amp;coppa=&amp;<?php echo _rsid; ?>">Before <?php echo strftime('%B %d, %Y', $coppa); ?></a>]&nbsp;
		[<a href="/index.php?t=pre_reg&amp;coppa=1&amp;<?php echo _rsid; ?>">After <?php echo strftime('%B %d, %Y', $coppa); ?></a>]
		<hr/>
