...
<tr class="child-c2 RowStyleA" style="display: none;">
	<td colspan="2">
		...
		<tr>
			...
			<td>
				<label>AIM Handle:<br /><img src="/theme/default/images/aim.png" alt="" />
		...
		<tr>
			...
			<td>
				<label>MSN Messenger:<br /><img src="/theme/default/images/msnm.png" alt="" />
		...
		<tr>
			<td>
				<label>Jabber Handle:<br /><img src="/theme/default/images/jabber.png" alt="" />
				<input type="text" name="reg_jabber" value="<?php echo $reg_jabber; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Google Chat/IM Handle:<br /><img src="/theme/default/images/google.png" alt="" />
		...
		<tr>
			<td>
				<label>Skype Handle:<br /><img src="/theme/default/images/skype.png" alt="" />
				<input type="text" name="reg_skype" value="<?php echo $reg_skype; ?>" maxlength="32" size="25" />
				</label>
			</td>
			<td>
				<label>Twitter Handle:<br /><img src="/theme/default/images/twitter.png" alt="" />
...
<script>
        min_max_cats("/theme/default/images", "Minimize Category", "Maximize Category", "", "");
            ...
            $("#reg_login").change(function() {
                 ...
                 $.ajax({
                    ...
                    success:function(data) {
                        if (data==1) {
                            $("#reg_login-result").html("<img src='/theme/default/images/tick.png' />Available");
                        } else {
                            $("#reg_login-result").html("<img src='/theme/default/images/cross.png' /> Already taken");
                        }
                    }
                 });
            });
