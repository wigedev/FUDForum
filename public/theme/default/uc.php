...
'.$uc_sub_forum;
	...
	while ($r = db_rowobj($c)) {
		...
		$uc_sub_topic .= '<tr>
	<td class="RowStyleA"><a href="/index.php?t='.d_thread_view.'&amp;th='.$r->id.'&amp;unread=1&amp;'._rsid.'"><img src="/theme/default/images/newposts.gif" title="Go to the first unread message in this topic" alt="" /></a>&nbsp;<a class="big" href="/index.php?t='.d_thread_view.'&amp;th='.$r->id.'&amp;'._rsid.'">'.$r->subject.'</a> '.$mini_thread_pager.'<br /><div class="ar"><a href="/index.php?t=post&amp;th_id='.$r->id.'&amp;'._rsid.'">Reply</a> || <a href="/index.php?t=uc&amp;utid='.$r->id.'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Unsubscribe</a></div></td>
